...
import kotlinx.android.synthetic.main.fragment_invalid_voucher.*

class InvalidVoucher : Fragment() {

  override fun onCreateView(
    inflater: LayoutInflater, container: ViewGroup?,
    savedInstanceState: Bundle?
  ): View? {
    return inflater.inflate(R.layout.fragment_invalid_voucher, container, false)
  }
