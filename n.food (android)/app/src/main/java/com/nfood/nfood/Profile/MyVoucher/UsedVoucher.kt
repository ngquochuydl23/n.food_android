...
import kotlinx.android.synthetic.main.fragment_used_voucher.*

class UsedVoucher : Fragment() {

  override fun onCreateView(
    inflater: LayoutInflater, container: ViewGroup?,
    savedInstanceState: Bundle?
  ): View? {
    return inflater.inflate(R.layout.fragment_used_voucher, container, false)
  }
